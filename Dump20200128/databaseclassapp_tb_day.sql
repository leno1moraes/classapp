...
LOCK TABLES `tb_day` WRITE;
/*!40000 ALTER TABLE `tb_day` DISABLE KEYS */;
INSERT INTO `tb_day` VALUES (1,'Segunda-Feira',1),(2,'Teça-Feira',1),(3,'Quarta-Feira',1),(4,'Quinta-Feira',1),(5,'Sexta-Feira',1),(6,'Sábado',NULL),(7,'Domingo',NULL);
/*!40000 ALTER TABLE `tb_day` ENABLE KEYS */;
UNLOCK TABLES;
