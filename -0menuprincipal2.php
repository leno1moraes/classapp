    ...
    <section class="sidebar" style="height: auto;">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="AdminTLEFiles/user2-160x160.jpg" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        ...
        <li><a href="#"><i class="fa fa-archive"></i> <span>Quadro de Horário</span></a></li>
        <li><a href="#"><i class="fa fa-edit"></i> <span>Solicitar Aula</span></a></li>
        <li><a href="#"><i class="fa fa-laptop"></i> <span>Autorizações</span></a></li>
        <li><a href="#"><i class="fa fa-th"></i> <span>Minhas Informações</span></a></li>
        <li><a href="#"><i class="fa fa-archive"></i> <span>Minhas Solicitações</span></a></li>
        <li><a href="#"><i class="fa fa-tags"></i> <span>Minhas Matérias</span></a></li>
